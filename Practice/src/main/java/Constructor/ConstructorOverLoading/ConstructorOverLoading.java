...
public class ConstructorOverLoading {
    ...
    public ConstructorOverLoading(int age) {
        System.out.println("practice.Constructor with one argument : " +
                "Int : " + age);
    }

    public ConstructorOverLoading(String name) {
        System.out.println("practice.Constructor with one " +
                "argument - String : " + name);
    }

    public ConstructorOverLoading(int age, String name) {
        System.out.println("practice.Constructor with two arguments : " +
